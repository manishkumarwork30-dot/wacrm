...
export const INDIA_STATES_AND_DISTRICTS: StateDistricts = {
  "Andhra Pradesh": [
    "Ananthapuramu", "Chittoor", "East Godavari", "Guntur", "Kadapa", "Krishna", 
  ...
  "Bihar": [
    ...
    "Patna", "Purnia (Purnea)", "Rohtas", "Saharsa", "Samastipur", "Saran", "Sheikhpura", 
  ...
  "Karnataka": [
    ...
    "Chikkamagaluru (Chickmagalur)", "Chitradurga", "Dakshina Kannada", "Davangere", 
  ...
  "Punjab": [
    ...
    "Mansa", "Moga", "Muktsar", "Pathankot", "Patiala", "Rupnagar", "Sahibzada Ajit Singh Nagar (Mohali)", 
  ...
  "Uttar Pradesh": [
    "Agra", "Aligarh", "Allahabad", "Ambedkar Nagar", "Amethi (Chatrapati Sahuji Maharaj Nagar)", 
    "Amroha (Jyotiba Phule Nagar)", "Auraiya", "Azamgarh", "Baghpat", "Bahraich", 
    ...
    "Kanpur Nagar", "Kasganj (Kanshiram Nagar)", "Kaushambi", "Kushinagar (Padrauna)", 
    ...
    "Sant Kabir Nagar", "Shahjahanpur", "Shamali (Prabuddh Nagar)", "Shravasti", 
  ...
  "West Bengal": [
    ...
    "Paschim Medinipur (West Medinipur)", "Paschim Burdwan (West Bardhaman)", 
    "Purba Burdwan (East Bardhaman)", "Purba Medinipur (East Medinipur)", 
